...
@section('headers')
<title>Disocover Products With AnyBringr</title>
...
<meta name="copyright" content="©Disocover Products With AnyBringr" />
<meta property='og:locale' content='en_US' />
<meta property="og:locale:alternate" content='bn_BD' />
<meta property="og:title" content="Disocover Products With AnyBringr" />
...
<main class="max-w-[1400px] mx-auto px-3 mt-3 sm:px-6 md:px-8">
    ...
    <div class="products" style="align-items: unset">
        ...
        <div class="product border-slate-300 border-solid !border-2" style="justify-content: space-between !important">
...
<div class="custom-pagination" style="margin-top: 50px !important">
    <ul class="pagination">
        ...
        @else
        <li><a href="{{ $products->previousPageUrl() }}"><i class="fa-solid fa-angle-left"></i> Previous</a></li>
        @endif
