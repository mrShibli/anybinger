...
@section('headers')
    <title>Disocover Products {{ Str::ucfirst($category) }} {{ $subcategory ? '- ' . Str::ucfirst($subcategory) : '' }}</title>
    ...
    <meta name="copyright" content="© Disocover Products {{ Str::ucfirst($category) }} {{ $subcategory ? '- ' . Str::ucfirst($subcategory) : '' }}" />
    <meta property='og:locale' content='en_US' />
    <meta property="og:locale:alternate" content='bn_BD' />
    <meta property="og:title" content="Disocover Products {{ Str::ucfirst($category) }} {{ $subcategory ? '- ' . Str::ucfirst($subcategory) : '' }}" />
