                ...
                <div class="card">
                  <form id="TReviewForm" class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <textarea  name="review" id="review" class="form-control" style="height: 110px !important"></textarea>
                    </div>

                    <div class="mt-2">
                        <button class="btn btn-info" id="SaveBtn">Save Review</button>
                    </div>
                   </form>
                  </div>
                </div>
...
@section('customJs')
    <script>
        ...
        $('#TReviewForm').on('submit', function(e){
            ...
            $.ajax({
                url: "{{ route('travelerreviews.store') }}",
                type: 'post',
